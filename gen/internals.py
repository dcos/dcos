...
# the name
LATE_BIND_PLACEHOLD_START = 'LATE_BIND_PLACEHOLDER_START_'
LATE_BIND_PLACEHOLDER_END = '_LATE_BIND_PLACEHOLDER_END'
LATE_BIND_PLACEHOLDER = LATE_BIND_PLACEHOLD_START + '{}' + LATE_BIND_PLACEHOLDER_END
...
class Resolver:
    ...
    def _ensure_finalized(self, resolvable):
        ...
        with self._stack_layer(resolvable.name):
            ...
            except LateBoundException as ex:
