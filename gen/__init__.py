                    ...
                    "cols": [
                        {
                            ...
                            "help": "The private IP addresses of the master; should be 1, 3, 5, 7 or 9",
                            "uploadable": True,
                            "hidden": False,
                            "width-factor": 1.0,
                    ...
                    "cols": [
                        {
                            ...
                            "place-holder": "Specify a comma-separated list of 1 to 'n' private IPv4 addresses"
                        },
                        {
                            ...
                            "help": "",
                            "uploadable": True,
                            "place-holder": "Specify a comma-separated list of 1 to 'n' public IPv4 addresses"
                        }
                    ]
                },
                {
                    ...
                    "cols": [
                        {
                            ...
                            "place-holder": "Specify one public IPv4 address."
                        },
                        {
                            "validation_param": "ssh_user",
                            "title": "SSH Usernname",
                            "place-holder": "e.g. root, admin, core"
                        },
                        {
                            "validation_param": "ssh_port",
                            "title": "SSH Listening Port",
                            "place-holder": "1-65000"
                        }
                    ]
                },
                {
