...
class NSSMParameter(enum.Enum):
    ...
    APPROTATEBYTESHIGH = 'approtatebyteshigh'
    APPROTATEONLINE = 'approtateonline'
    APPROTATESECONDS = 'approtateseconds'
    APPTIMESTAMPLOG = 'apptimestamplog'
    APPAFFINITY = 'appaffinity'
    APPEXIT = 'appexit'
    APPNOCONSOLE = 'appnoconsole'
    APPPRIORITY = 'apppriority'
    APPRESTARTDELAY = 'apprestartdelay'
    APPSTDERRCREATIONDISPOSITION = 'appstderrcreationdisposition'
    APPSTDERRFLAGSANDATTRIBUTES = 'appstderrflagsandattributes'
    APPSTDERRSHAREMODE = 'appstderrsharemode'
    APPSTDIN = 'appstdin'
    APPSTDINCREATIONDISPOSITION = 'appstdincreationdisposition'
    APPSTDINFLAGSANDATTRIBUTES = 'appstdinflagsandattributes'
    APPSTDINSHAREMODE = 'appstdinsharemode'
    APPSTDOUTCREATIONDISPOSITION = 'appstdoutcreationdisposition'
    APPSTDOUTFLAGSANDATTRIBUTES = 'appstdoutflagsandattributes'
    APPSTDOUTSHAREMODE = 'appstdoutsharemode'
    APPSTOPMETHODCONSOLE = 'appstopmethodconsole'
    APPSTOPMETHODSKIP = 'appstopmethodskip'
    APPSTOPMETHODTHREADS = 'appstopmethodthreads'
    APPSTOPMETHODWINDOW = 'appstopmethodwindow'
    APPTHROTTLE = 'appthrottle'
