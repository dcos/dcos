...
class TestUpstreamsEnvVarBehaviour:
    def test_if_marathon_upstream_env_is_honoured(
        ...
        filter_regexp = {
            ...
            'GET http://127.0.0.1:8080/v2/leader': SearchCriteria(1, True),
            (r'GET http://127.0.0.1:8080/v2/apps'
        ...
        filter_regexp = {
            ...
            'GET http://127.0.0.2:8080/v2/leader': SearchCriteria(1, True),
            (r'GET http://127.0.0.2:8080/v2/apps'
             r'\?embed=apps\.tasks\&label=DCOS_SERVICE_NAME'): SearchCriteria(1, True),
        }
    ...
    def test_if_mesos_upstream_env_is_honoured(
        ...
        filter_regexp = {
            ...
            'GET http://127.0.0.2:5050/master/state-summary': SearchCriteria(1, True),
        }
        ...
        filter_regexp = {
            ...
            'GET http://127.0.0.3:5050/master/state-summary': SearchCriteria(1, True),
        }
