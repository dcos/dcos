...
from pkgpanda.util import hash_str, write_string
...
def generate_node_upgrade_script(gen_out, installed_version, serve_dir=SERVE_DIR):
    ...
    bash_script = gen.template.parse_str(node_upgrade_template).render({
        ...
        'installed_cluster_version': installed_version,
