...
* Upgraded CockroachDB to version [2.1.7](https://www.cockroachlabs.com/docs/releases/v2.1.7.html).
...
* Updated DC/OS UI to [master+v2.105.0](https://github.com/dcos/dcos-ui/releases/tag/master+v2.105.0)
