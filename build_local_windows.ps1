...
# Upload dcos_generate_config_win.sh to S3 location downloads.mesosphere.com/dcos/testing/<branch>/windows/
# For pull requests, the <branch> will pull/<pr-number>
Write-Output "Upload to https://downloads.mesosphere.com/dcos/testing/$env:TEAMCITY_BRANCH/windows/dcos_generate_config_win.sh"
...
# Upload dcos_generate_config_win.sh to S3 location downloads.mesosphere.com/dcos/testing/<branch>/windows/
# For pull requests, the <branch> will pull/<pr-number>
Write-Output "Upload to https://downloads.mesosphere.com/dcos/testing/$env:TEAMCITY_BRANCH/commit/$env:BUILD_VCS_NUMBER/windows/dcos_generate_config_win.sh"
