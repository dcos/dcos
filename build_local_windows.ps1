...
Write-S3Object -BucketName "s3-us-west-2.amazonaws.com/downloads.dcos.io" -Key "dcos\testing\skumaran\dcos_generate_config_win.sh" -File ".\dcos_generate_config_win.sh" -CannedACLName public-read
